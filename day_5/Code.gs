// Configuration
const SPREADSHEET_ID = "1uupBclcMjFJQJcAwUrbnFCwcM_Oa8camF2kDs9l5xsc"; // Replace with your actual spreadsheet ID
const SHEET_NAME = "Applications";
const secretKey = "geeks-secret"; // Must match the one in your JavaScript
